...
if($type==0){
    ...
    <div class="contentitem">
		...
		echo $intro;
		?>
        <p class="viewreadmore"><a href="index.php?option=com_content&view=article&id=<?php echo $lists[0]->id?>&catid=<?php echo $catid[0];?>&Itemid=<?php echo $Itemidmenu?>"><?php echo JText::_('View Offer'); ?></a></p>
    </div>
    <?php
}
elseif($type==1){
...
function submitgettouch(){
	...
	if (touch_name == ''){alert('<?php echo JText::_('Please input your name!');?>');f.touch_name.focus();}
		...
		document.getElementById('gtname').value = touch_name;
		document.getElementById('gtemail').value = touch_email;
		document.getElementById('gtmessage').value = touch_message;
		f.submit();
	}
}
</script>
...
<form id="formgetintouch" class="formgetintouch" name="formgetintouch" action="contact-us" method="post">
	<input type="text" id="touch_name" class="txttouch" placeholder="<?php echo JText::_('Name'); ?>" value="" />
    <input type="email" id="touch_email" class="txttouch" placeholder="<?php echo JText::_('Email'); ?>" value="" />
    <textarea id="touch_message" class="txttouch messagetxt" placeholder="<?php echo JText::_('Message'); ?>"></textarea>
    <input type="button" id="touch_btn" class="btn_send" value="<?php echo JText::_('Send'); ?>" onclick="submitgettouch();" />
    <input type="hidden" id="gtname" value="" />
    <input type="hidden" id="gtemail" value="" />
    <input type="hidden" id="gtmessage" value="" />
</form>
</div>
<?php
}
...
['<div class=info><h4>Family Medical Practice</h4><div class="contentmap introtext">Diamond Plaza, 34 Le Duan, Dist 1, HCMC</div></div>', 10.781471,106.698551],
    ...
    var iconURLPrefix = 'http://sherwoodresidence.com/sherwood2014/templates/protostar/images/iconmap/';
    var icons = [  
    ...
    function mapclick(sott){
		...
		infowindow.setPosition(locations[sott][1]);
		infowindow.open(map, marker);
    };
    function AutoCenter() {
	...
	<form name="chooseDateForm" id="chooseDateForm" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
    	...
    	<div class="forminquiry_right">
            ...
            <div class="control-group unittypes">
                ...
                <div class="controls">
                	<span class="checkboxunittypes"><input type="checkbox" id="unittypes1" name="unittypes1" value="2 bedroom (82 sqm)">2 bedroom (82 sqm)</span>
                    <span class="checkboxunittypes right"><input type="checkbox" id="unittypes2" name="unittypes2" value="2 bedroom (124 sqm)">2 bedroom (124 sqm)</span>
                    <span class="checkboxunittypes"><input type="checkbox" id="unittypes3" name="unittypes3" value="3 bedroom (138 sqm)">3 bedroom (138 sqm)</span>
                    <span class="checkboxunittypes right"><input type="checkbox" id="unittypes4" name="unittypes4" value="3 bedroom (143 sqm)">3 bedroom (143 sqm)</span>
                    <span class="checkboxunittypes"><input type="checkbox" id="unittypes5" name="unittypes5" value="Penthouse">Penthouse</span>
                </div>
            </div>
            <div class="control-group interestedin">
                <div class="control-label"><?php echo JText::_('Interested in'); ?></div>
                <div class="controls">
                	<span class="checkboxinterestin"><input type="checkbox" id="interestin1" name="2room82" value="Less than 3 months">Less than 3 months</span>
                    <span class="checkboxinterestin right"><input type="checkbox" id="interestin2" name="2room124" value="6 months – 1 year">6 months – 1 year</span>
                    <span class="checkboxinterestin"><input type="checkbox" id="interestin3" name="3room138" value="1 year – 2 years">1 year – 2 years</span>
                    <span class="checkboxinterestin right"><input type="checkbox" id="interestin4" name="3room143" value="2 years – longer">2 years – longer</span>
                </div>
            </div>
...
?>
    ...
    <div class="ui-tabs ui-widget ui-widget-content ui-corner-all pagenewslist" id="tabs">
        ...
        if($lang=="en"){$linkform = "http://sherwoodresidence.com/sherwood2014/index.php/en/news-year";}else if($lang=="vn"){$linkform = "http://sherwoodresidence.com/sherwood2014/index.php/en/news-year";}else{$linkform = "http://sherwoodresidence.com/sherwood2014/index.php/en/news-year";}?><script>function formyearnews(yearnewsinput){var f=document.getElementById('yearnews');document.getElementById('yearnewsofinput').value = yearnewsinput;f.submit();}</script>
