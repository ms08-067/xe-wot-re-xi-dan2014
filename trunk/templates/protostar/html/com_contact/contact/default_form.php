...
<?php
$touch_name		= $_POST['touch_name'];
$touch_email	= $_POST['touch_email'];
$touch_message	= $_POST['touch_message'];
echo $touch_name;
echo $touch_email;
echo $touch_message;
?>
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate form-horizontal">
		<fieldset>
			<legend style="display:none;"><?php echo JText::_('COM_CONTACT_FORM_LABEL'); ?></legend>
