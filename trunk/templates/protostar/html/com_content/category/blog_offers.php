...
<div class="contentcatintro offercontent">
    ...
    <a class="roomdetail" href="index.php?option=com_content&view=article&id=<?php echo $this->item->id?>&catid=<?php echo $this->item->catid?>&Itemid=110"><?php echo JText::_('Read More'); ?></a>
